var list_action = (function() {
	return{
		...
		change_yajin : function(url,spu_id,sku_id,yajin){
            $.post(url,{spu_id:spu_id,sku_id:sku_id,yajin:yajin},function(data){
                if(data.status == 1){
                    return true;
                }else{
                    return false;
        ...
        change_buyout_price : function(url,spu_id,sku_id,buyout_price){
            $.post(url,{spu_id:spu_id,sku_id:sku_id,buyout_price:buyout_price},function(data){
                if(data.status == 1){
                    return true;
                }else{
                    return false;
