...
class SendEmailApi {
    ...
    private $fromName = '机市';//发件人姓名（昵称）可为任意内容
    private $userName = 'yaodongxu@huishoubao.com.cn';//发件人smtp登录账号
    private $password = 'Ydxmy0919';//发件人smtp登密码
    private $from = 'yaodongxu@huishoubao.com.cn';//发件人邮箱地址
