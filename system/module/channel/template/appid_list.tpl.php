<?php include template('header','admin');?>
	<script type="text/javascript" src="./statics/js/goods/goods_list.js"></script>
		<div class="fixed-nav layout">
			<ul>
				<li class="first">入口管理<a id="addHome" title="添加到首页快捷菜单">[+]</a></li>
				<li class="spacer-gray"></li>
                <?php
                foreach ($status_tabs as $tab){
                    echo '<li>'. $tab .'</li>';
                }
                ?>
			</ul>
		...
		<div class="content padding-big have-fixed-nav">
            ...
            <div class="clearfix">
                <form method="get">
                    ...
                    <input type="hidden" name="c" value="channel_appid"/>
                    <input type="hidden" name="a" value="index"/>
                    <div class="order2-list-search clearfix">
                        <div class="form-box clearfix border-bottom-none">
                            <?php echo form::input('select', 'channel_id', $_GET['channel_id'] ? $_GET['channel_id'] : '0', '按渠道查看：', '', array('css' => 'form-layout-rank', 'items' => $channel_list)) ?>
                            <?php echo form::input('select', 'type', $_GET['type'] ? $_GET['type'] : '0', '按类型查看：', '', array('css' => 'form-layout-rank', 'items' => $type_list)) ?>
                            <div class="form-group form-layout-rank">
                                <div class="box keywords margin-none">
                                    <input class="input keywords" name="keywords" placeholder="按入口名称或appid查询" tabindex="0" type="text"
			...
			<div class="table-wrap resize-table">
				...
				<div class="tr">
					...
					<span class="td">
						<span class="td-con">
						<a href="<?php echo url('edit',array('id'=>$list['id']))?>">编辑</a></span>
					</span>
				</div>
				<?php }?>
