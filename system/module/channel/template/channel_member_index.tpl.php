...
<div class="fixed-nav layout">
    <ul>
        <li class="first">账户管理<a id="addHome" title="添加到首页快捷菜单">[+]</a></li>
...
<div class="content padding-big have-fixed-nav">
    ...
    <div class="table-work border margin-tb">
        <div class="border border-white tw-wrap">
            ...
            <a data-message="删除所选账号，对应绑定的手机号也会被删除。是否确定删除所选？" href="<?php echo url('delete')?>" data-ajax='id'><i class="ico_delete"></i>删除</a>
            <div class="spacer-gray"></div>
        </div>
    </div>
                ...
                <div class="tr">
                    ...
                    <span class="td">
						<span class="td-con">
                            ...
                            <a href="<?php echo url('bind',array('id'=>$list['id']))?>">绑定手机号</a>&nbsp;&nbsp;&nbsp;
                            <a data-confirm="删除该账号，对应绑定的手机号也会被删除。是否确认删除？" href="<?php echo url('delete', array('id[]' => $list['id'])); ?>">删除</a><?php echo $lists['option']?>
                        </span>
					</span>
                </div>
            <?php }?>
