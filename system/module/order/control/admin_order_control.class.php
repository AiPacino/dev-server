...
class admin_order_control extends init_control {
	...
	public function _initialize() {
		...
		$this->service_order_sku = $this->load->service('order/order_sku');
	}
	...
	public function index() {
		...
		$lists = array(
				'th' => array(
						'username' => array('title' => '订单编号','length' => 12),
						'sn' => array('title' => '会员帐号','length' => 9),
						'address_name' => array('length' => 9,'title' => '会员姓名'),
						'system_time' => array('length' => 9,'title' => '下单时间','style'=>'date'),
						'address_mobile' => array('title' => '会员帐号','length' => 9),
						'address_mobile1' => array('title' => '租期','length' => 9),
						'address_mobile2' => array('title' => '租期周期','style'=>'date'),
						'address_mobile3' => array('title' => '租借剩余天数','length' => 7),
						'address_mobile4' => array('title' => '选购产品','length' => 7),
						'real_amount1' => array('length' => 7,'title' => '订单金额'),
						'address_mobile12' => array('title' => '是否免押','length' =>7),
						'_status' => array('length' => 7,'title' => '订单状态','style'=>'_status'),
				),
				'lists' => $orders,
				'pages' => $pages,
	...
	public function timelist()
	{
		...
		$lists = array(
				'th' => array(
						'sn' => array('title' => '订单编号','length' => 12),
						'username' => array('title' => '会员帐号','length' => 9),
						'address_name' => array('length' => 9,'title' => '会员姓名'),
						'system_time' => array('length' => 9,'title' => '下单时间','style'=>'date'),
						'address_mobile' => array('title' => '会员帐号','length' => 9),
						'address_mobile1' => array('title' => '租期','length' => 9),
		...
		//var_dump($lists);exit;
		$this->load->librarys('View')->assign('lists',$lists)->assign('pages',$pages)->display('timelist');
	}
	/* 
         * 订单详细页面 
         */
	...
	/**
         * 发货单模版 (GET请求为查看，POST为修改表单提交)
         */
	public function tpl_parcel() {
		if (checksubmit('dosubmit')) {
			$result = $this->service_tpl_parcel->update($_POST);
			...
			showmessage(lang('_operation_success_'),$url,1,'json');
		} else {
			$info = $this->service_tpl_parcel->get_tpl_parcel_by_id(1);
			$name = '发货单模版';
			$this->load->librarys('View')->assign('info',$info)->assign('tpl_name', $name)->display('tpl_parcel');
		}
	}
