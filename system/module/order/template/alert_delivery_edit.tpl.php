<?php include template('header','admin');?>
	...
	<div class="form-box border-bottom-none order-eidt-popup invoice-form-box clearfix">
		<div id="shows">
			...
			<?php echo form::input('select','delivery_id',$order_deliverys['delivery_id'] ? $order_deliverys['delivery_id'] : $first_key,'物流公司：','',array('items' => $deliverys)) ?>
			<?php echo form::input('text', 'delivery_sn', $order_deliverys['delivery_sn'],'物流单号：','',array('datatype' => '*')); ?>
		</div>
	</div>
	...
	<div class="padding text-right ui-dialog-footer">
		<input type="hidden" name="o_sku_ids" value="<?php echo $order_deliverys['o_sku_ids'];?>" />
		<input type="hidden" name="o_delivery_id" value="<?php echo $_GET['delivery_id'];?>" />
