...
<div id="dialog_box">
    <form action="<?php echo url('payment/fundauth/deposit_unfreeze')?>" method="POST" name="parcel_form">


        <div class="form-box border-bottom-none order-eidt-popup clearfix">
            <?php echo form::input('text', 'amount', $jiedongamount, '押金解冻金额 ( 解冻金额 ≤ '. $jiedongamount.' 元)', '', array('datatype' => '*', 'nullmsg' => '请填写解冻金额','maxlength'=>10,'onblur'=>'check_num(this.value)')); ?>
        </div>
        <div class="form-box border-bottom-none order-eidt-popup clearfix">
