...
class spec_service extends service {
	...
	public function edit_spec($params){
		...
		if((int)$params['id'] < 1 || $params['id'] ==1 || $params['id'] ==4){
     ...
     * @return [int]
     */
    public function spec_transformation_chengse($key){
        $chengse = array('全新'=>100,'99成新'=>99,'95成新'=>95,'9成新'=>90,'8成新'=>80,'7成新'=>70,);
        return $chengse[$key];
    }
    /**
     * 规格属性转换 [租期]
     ...
     * @return [int]
     */
    public function spec_transformation_zuqi($key){
        //$zuqi = array('12期'=>12,'6期'=>6,'3期'=>3,'30天'=>1,'15天'=>1,'7天'=>1);
        $zuqi = array('12期'=>12,'6期'=>6,'3期'=>3,'30天'=>30,'15天'=>15,'7天'=>7);
        return $zuqi[$key];
    }
     ...
     * @return [int]
     */
    public function spec_transformation_zuqi_type($key){
        $type = array('12期'=>2,'6期'=>2,'3期'=>2,'30天'=>1,'15天'=>1,'7天'=>1);
        return $type[$key];
    }
