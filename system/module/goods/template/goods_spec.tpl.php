...
<div class="table resize-table border clearfix">
    <div class="tr border-none spec-name">
        ...
        <div class="th" data-width="8">
            <div class="td-con">租金(天/月)</div>
        </div>
        <div class="th" data-width="8">
            <div class="td-con">市场价格</div>
        </div>
        <div class="th" data-width="8">
            <div class="td-con">押金</div>
        </div>
        <div class="th" data-width="8">
            <div class="td-con">买断价格</div>
        </div>
        <div class="th" data-width="5">
            <div class="td-con">库存</div>
        </div>
        <div class="th" data-width="5">
            <div class="td-con">预备库存</div>
        </div>
        <div class="th" data-width="8">
    ...
    <script id="spec_template" type="text/html">
        ...
        <div class="tr spec-list" data-id='<%=item['spec_md5']%>'>
            ...
            <div class="td" data-column='yajin'>
                <div class="td-con"><input class="input" type="text" nullmsg="押金请填写大于零的正整数" datatype="price" attr="yajin[<%=item['spec_md5']%>]" value="<%=item['yajin']?item['yajin']:'0.00'%>"/></div>
            </div>
            <div class="td" data-column='buyout_price'>
                <div class="td-con"><input class="input" type="text" nullmsg="买断价格必须为数字" datatype="price" attr="buyout_price[<%=item['spec_md5']%>]" value="<%=item['buyout_price']?item['buyout_price']:'0.00'%>"/></div>
            </div>
            ...
            <div class="td" data-column='pre_number'>
                <div class="td-con"><input class="input" type="text" nullmsg="预备库存必须为数字" datatype="n" attr="pre_number[<%=item['spec_md5']%>]" value="<%=item['pre_number']?item['pre_number']:'0'%>" /></div>
            </div>
