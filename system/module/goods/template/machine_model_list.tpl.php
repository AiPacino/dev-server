...
<div class="fixed-nav layout">
    <ul>
        <li class="first">商品机型<a id="addHome" title="添加到首页快捷菜单">[+]</a></li>
                    ...
                    <?php foreach ($list as $key => $value) {?>
						...
						<div class="double-click">
                            ...
                            <?php }elseif ($lists['th'][$key]['style'] == 'ico_up_rack') {?>
                                <span class="td">
						<a class="ico_up_rack <?php if($value != 1){?>cancel<?php }?>" href="javascript:;" data-id="<?php echo $list['id']?>" title="点击禁用"></a>
					</span>
