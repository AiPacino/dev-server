...
<script type="text/javascript" src="./statics/js/upload/uploader.js"></script>
		<div class="table clearfix">
			<div class="tr">
				...
				<div class="th w15">月租价格</div>
				<div class="th w15">市场价格</div>
                <div class="th w15">押金</div>
                <div class="th w10">买断价格</div>
				<div class="th w10">库存</div>
                <div class="th w10">预备库存</div>
			</div>
			<div class="tr">
				<div class="td w25">
					<div class="td-con">
                ...
                <div class="td w15">
                    <div class="td-con">
                        <input class="input" type="text" name="yajin" value="+0.00" />
                    </div>
                </div>
                <div class="td w10">
                    <div class="td-con">
                        <input class="input" type="text" name="buyout_price" value="+0.00" />
                    </div>
                </div>
				<div class="td w10">
					<div class="td-con">
                ...
                <div class="td w10">
                    <div class="td-con">
                        <input class="input" type="text" name="pre_number" value="+0" />
                    </div>
                </div>
			</div>
		</div>
		...
		<script type="text/javascript">
			$(window).load(function(){
				...
				$('#okbtn').on('click', function () {
					var data = [$('input[name="sn"]').val(),$('input[name="shop_price"]').val(),$('input[name="market_price"]').val(),$('input[name="yajin"]').val(),$('input[name="buyout_price"]').val(),$('input[name="number"]').val(),$('input[name="pre_number"]').val()];
