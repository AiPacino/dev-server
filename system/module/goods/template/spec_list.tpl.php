...
<style>
.div_disabled{ text-align:left;background-color: transparent; padding-left:5px}
</style>
	...
	<script type="text/javascript" src="./statics/js/goods/goods_list.js"></script>
		...
		<div class="content padding-big have-fixed-nav">
			...
			<div class="table paging-table resize-table check-table border clearfix">
				...
				<div class="tr">
					...
					<span class="td">
                     <?php if($list['id']!=1&&$list['id']!=4){ ?>
						<div class="double-click">
							<a class="double-click-button margin-none padding-none disabled" title="双击可编辑" href="javascript:;" data-id="<?php echo $list['id']?>"></a>
                     ...
                     <?php }else{ ?>
                        <div>
							<div class="div_disabled"><?php echo $value?></div>
						</div>
                     <?php } ?>
					</span>
					<?php }elseif ($lists['th'][$key]['style'] == 'ident') {?>
						<span class="td ident">
                          ...
                          <?php if($list['id']!=1&&$list['id']!=4){ ?>
							<div class="double-click">
								<a class="double-click-button margin-none padding-none disabled" title="双击可编辑" href="javascript:;" ondblclick="false" data-id="<?php echo $list['id']?>"></a>
		...
		<script>
		//扩展开始
		$(".disabled").live("dblclick",function(k, v) {
                if($(this).attr("data-id") == 1||$(this).attr("data-id") == 4){
					$(this).removeClass("double-click-button").parents("tr").unbind();
				}
            });	
