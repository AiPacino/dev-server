			...
			<div class="setspec-popup bg-white">
				<div class="left fl">
					...
					<div class="spec-left-body border">
						...
						<a data-id="<?php echo $spec['id']?>" class="specname" href="javascript:;"><?php echo $spec['name']?><em>[0]</em>
                        <?php if($spec['id']!=1&&$spec['id']!=4){?>
                        <i>×</i>
                        <?php }?>
                        </a>
						<?php }?>
						...
						<div class="top border spec_choose">
							...
							<div class="wrap hidden spec-num" data-id="<?php echo $spec['id']?>">
								<?php foreach ($spec['value'] AS $v) {?>
									<a data-id="<?php echo $spec['id']?>" data-name="<?php echo $spec['name']?>" data-value="<?php echo $v?>" data-style="" data-color="" data-img="" href="javascript:;"><?php echo $v?>
                                    <?php if($spec['id']!=1&&$spec['id']!=4){?>
                                    <i>×</i>
                                    <?php }?>
                                    </a>
