	...
	<div class="clearfix">
		<form method="get" >
			...
			<div class="form-group form-layout-rank border-none" style="width: 300px;">
				...
				<span class="label" style="width: auto;">时间</span>
				<div class="box ">
					<div >
						<input class="input" type="text"  style="width: 100px;"  name="keyword" value="<?php echo $_GET['keyword'] ?>" placeholder="时间框" >
					</div>
				</div>
						...
						<div class="tr">
							...
							<span class="td">
									<span class="td-con">
										...
										<?php else: ?>
											<a href="<?php echo url('order2/order/detail',array('sub_sn' => $list['sn'])); ?>">查看</a>
										<?php endif; ?>
									</span>
								</span>
						</div>
