...
<body>
	...
	<div class="content padding-big have-fixed-nav">
		...
		<table cellpadding="0" cellspacing="0" class="border bg-white layout margin-top">
			<tbody>
				<tr class="bg-gray-white line-height-40 border-bottom">
					<th class="text-left padding-big-left">不同入口每日下单量导出(时间截止：至今)</th>
				</tr>
				<tr class="border">
					<td class="padding-big-left padding-big-right">
						<table cellpadding="0" cellspacing="0" class="layout">
		...
		function DrawEChart(ec) {
			...
			myChart.setOption({
				...
				series: [{
                    ...
                    data: search.series['refund_amounts']
                }]
			});
	...
	$(function(){
		...
		$('#export').click(function(){
			...
			window.location.href = "<?php echo url('diff_order_export')?>" + "&start_time=" + start_time;
		});
	})
</script>
