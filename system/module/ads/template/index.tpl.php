...
<script type="text/javascript" src="./statics/js/goods/goods_list.js"></script>
	<body>
		<div class="fixed-nav layout">
			...
			<div class="clearfix">
				<form method="get" >
					<input type="hidden" name="m" value="ads" />
					<input type="hidden" name="c" value="admin" />
					<input type="hidden" name="a" value="index" />
					<div class="order2-list-search clearfix">
						<div class="form-box clearfix border-bottom-none" >
							<?php echo form::input('select','position_id',$_GET['position_id'] ? $_GET['position_id'] : '0','按位置查询','',array('css'=>'form-layout-rank','items' => $position))?>
						</div>
