...
<div class="fixed-nav layout">
    <ul>
		...
		<li class="fixed-nav-tab"><a href="javascript:;">蚁盾设置</a></li>
    </ul>
...
', array('items' => array('订单下单时减库存','订单付款时减库存', '订单发货时减库存',))); ?>
    ...
    <div class="content-tabs hidden">
        <div class="form-box clearfix">
		<?php echo form::input('text', 'yidun_score', $setting['yidun_score'], '蚁盾风控分数[1-100整数，用户分数大于设置的分数将不能下单]：', '蚁盾风控分数，验证下单用户蚁盾分数(分数越高风险越大)'); ?>
        </div>
    </div>
    <div class="padding">
