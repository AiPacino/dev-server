									...
									<table cellpadding="0" cellspacing="0" class="layout">
										<tbody>
											...
											<tr class="text-lh-big">
												<td>待付款订单：<a href="<?php echo url('order2/order/index') ?>" title="点击去查看"><b class="text-main" data-id="pay">0</b></a></td>
												<td>已支付订单：<a href="<?php echo url('order2/payment/index',array('payment_status' => 5)) ?>" title="点击去查看"><b class="text-main" data-id="confirm">0</b></a></td>
												<td>待发货订单：<a href="<?php echo url('order2/delivery/index',array('delivery_status' => 2)) ?>" title="点击去查看"><b class="text-main" data-id="delivery">0</b></a></td>
											</tr>
											<tr class="text-lh-big">
												<td>待退货申请：<a href="<?php echo url('order2/order/index') ?>" title="点击去查看"><b class="text-main" data-id="load_return">0</b></a></td>
												<td>待退款申请：<a href="<?php echo url('order2/order/index') ?>" title="点击去查看"><b class="text-main" data-id="load_refund">0</b></a></td>
											</tr>
										</tbody>
									</table>
								</td>
						...
						<tbody>
							...
							<tr class="border-bottom">
								<td class="text-left today-sales padding-big padding-small-top padding-small-bottom line-height-40">
									...
									<a href="<?php echo url('order2/order/index') ?>" title="点击去查看"><span class="fr" data-id="finish">0</span></a>
								</td>
							</tr>
							<tr class="border-bottom">
								<td class="text-left today-sales padding-big padding-small-top padding-small-bottom line-height-40">
...
<!--                    <table cellpadding="0" cellspacing="0" class="margin-top border bg-white layout">
				...
				<div class="fl w50 padding-small-left">
					<table cellpadding="0" cellspacing="0" class="border bg-white layout">
						<tbody>
							<tr class="bg-gray-white line-height-40 border-bottom">
								<th class="text-left padding-big-left" colspan="2">资金管理</th>
							</tr>
							<tr class="border-bottom">
                                ...
                                <td class="text-left to本月day-sales padding-big line-height-40">
                                    <span class="fl">今日退款额</span>
                                    <span class="margin-left text-big fl">￥<em class="h2 fr" data-id="today-refund-amount">0.00</em></span>
                                </td>
							</tr>
							<tr class="border-bottom">
								<td class="text-left today-sales padding-big padding-small-top padding-small-bottom line-height-40">
                                ...
                                <td class="text-left today-sales padding-big padding-small-top padding-small-bottom line-height-40">
                                    <span class="fl">本月退款额</span>
                                    <span class="margin-left fl">￥ <em data-id="month-refund-amount">0.00</em></span>
                                    <span class="fr">以自然月统计</span>
                                </td>
							</tr>
							<tr>
                                ...
                                <td class="text-left today-sales padding-big padding-small-top padding-small-bottom line-height-40">
                                    <span class="fl">今年退款额</span>
                                    <span class="margin-left fl">￥ <em data-id="year-refund-amount">0.00</em></span>
                                </td>
							</tr>
						</tbody>
					</table>
						...
						<tbody>
							...
							<tr class="border-bottom">
								<td class="text-left today-sales padding-big padding-small-top padding-small-bottom line-height-40">
									...
									<span class="fr">机市<?php if(HD_BRANCH == 'stable'){?>稳定版&nbsp;<?php }else{?>开发版&nbsp;<?php }?>v<?php echo HD_VERSION ?></span>
								</td>
							</tr>
							<tr class="border-bottom">
								<td class="text-left today-sales padding-big padding-small-top padding-small-bottom line-height-40">
...
<script>
	...
	$.ajax({
		...
		success: function(ret) {
            ...
            $("[data-id='today-refund-amount']").text(ret.sales.today.refund_amount);
            $("[data-id='month-refund-amount']").text(ret.sales.month.refund_amount);
            $("[data-id='year-refund-amount']").text(ret.sales.year.refund_amount);
			/* 数据库大小 */
